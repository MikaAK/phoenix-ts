...
// Modified by: Mika Kalathil <https://github.com/MikaAK/>

declare const VSN: string
declare const SOCKET_STATES: {
  connecting: number;
  open: number;
  closing: number;
  closed: number;
};
declare const CHANNEL_STATES: {
  closed: string;
  errored: string;
  joined: string;
  joining: string;
};
declare const CHANNEL_EVENTS: {
  close: string;
  error: string;
  join: string;
  reply: string;
...
declare type StateChangeCallbacks = {
  open: Function[];
  close: Function[];
  error: Function[];
  message: Function[];
